...
function HamburgerIcon(_ref) {
  ...
  (0, _react.useEffect)(function () {
    if (openIcon) {
      var menuIcon = document.querySelector(".".concat(containerUID, "-hamburgerMenuIcon")) || document.querySelector(".".concat(containerUID, "-hamburgerMenuClosedIcon"));
      menuIcon.classList.add("".concat(containerUID, "-hamburgerMenuIcon"));
      menuIcon.classList.remove("".concat(containerUID, "-hamburgerMenuClosedIcon"));
    }
  }, [openIcon]);
  (0, _react.useEffect)(function () {
    if (closeIcon) {
      var menuIcon = document.querySelector(".".concat(containerUID, "-hamburgerMenuIcon")) || document.querySelector(".".concat(containerUID, "-hamburgerMenuClosedIcon"));
      menuIcon.classList.remove("".concat(containerUID, "-hamburgerMenuIcon"));
      menuIcon.classList.add("".concat(containerUID, "-hamburgerMenuClosedIcon"));
    }
  }, [closeIcon]);
