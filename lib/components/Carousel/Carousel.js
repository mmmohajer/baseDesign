...
var Carousel = function Carousel(_ref) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              dir === 'right' ? sliderContainer.current.classList.add('ISWAD-Carousel-moveRight') : sliderContainer.current.classList.add('ISWAD-Carousel-moveLeft');
              _context3.next = 4;
              return wait(transitionDuration * 1000);
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
    ...
    className: (0, _classnames["default"])('flex', 'ISWAD-Carousel-sliderContainer'),
    ref: function ref(el) {
