...
var _excluded = ["children", "moveRight", "setMoveRight", "moveLeft", "setMoveLeft", "moveToItemWithNum", "setMoveToItemWithNum", "minXDifferenceToMove", "initialTranslateX", "moveLeftTranslateX", "moveRightTranslateX", "transitionDuration", "transition_timing_function", "cursorIsHandOnItem", "className"];
...
var DraggableSlider = function DraggableSlider(_ref) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              dir === 'right' ? sliderContainer.current.classList.add('ISWAD-Draggable-moveRight') : sliderContainer.current.classList.add('ISWAD-Draggable-moveLeft');
              _context3.next = 4;
              return wait(transitionDuration * 1000);
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
    ...
    className: (0, _classnames["default"])('flex', 'ISWAD-Draggable-sliderContainer'),
    ref: function ref(el) {
